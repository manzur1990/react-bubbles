...
- [x] What steps can you take in your web apps to keep your data secure?
      <!-- By implementing authentication methods such as JSON Web Tokens in exchange for correct login credential from the user. -->
- [x] Describe how web servers work.
      <!-- Networks process incoming data requests over network protocols such as HTTP and others. The primary function of a web server is to store, process and deliver web pages to clients. The communication between client and server takes place using the Hypertext Transfer Protocol (HTTP) -->
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      <!-- 
      -Update = PUT, request to edit data in the server
      -Post = POST, to a base URL returning data to the server
      -Read   = GET, data from the database server
      -Delete = DELETE -->
